...
const ClearanceForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await addDoc(collection(db, "clearance"), formData);
        ...
        <>
          ...
          <div className="mt-6 text-sm text-gray-500">
            ...
            <ul className="list-disc pl-5">
              ...
              <li>
                If the Barangay has no Dry Seal, then leave the lower part of
                the Certificate empty.
              </li>
              <li>
                If the Certificate contains "Not Valid Without Seal," then the
                seal must be placed.
              </li>
              <li>
                If "Not Valid Without Seal" is present but no seal has been
                placed, then the Certificate is not valid and not accepted.
              </li>
            </ul>
          </div>
        </>
